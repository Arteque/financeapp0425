...
const ContentContainer = ({ children, props, colorMode, shadow, marginBlockEnd, className }) => {
  return (
    <div
      ...
      style={{
        ...
        background: `${
          colorMode === "dark" ? "var(--clr-grey-400)" : null
        }`,
        color: `${
          colorMode === "dark" ? "var(--clr-grey-100)" : null
        }`,
      }}
